        ...
        socket.on('update-driver-location', async (data) => {
            ...
            try {
                ...
                if (data.parcel_id) {
                    ...
                    console.log(colors_1.default.white(`[Socket] Broadcasting live update to room: ${roomName}`));
                ...
                console.error(colors_1.default.red(`[Socket] Location update error: ${msg}`));
