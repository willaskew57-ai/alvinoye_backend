...
router.patch('/update-me', auth(USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN, USER_ROLE.CUSTOMER, USER_ROLE.DRIVER), upload.fields([{ name: 'profile_image', maxCount: 1 }]), // Use multer fields
(req, res, next) => {
    if (req.body.data) {
