 ...
 */
router.post('/update-location', auth(USER_ROLE.DRIVER), TrackDriverControllers.updateLocation);
/**
 ...
 */
router.get('/nearby', auth(USER_ROLE.ADMIN, USER_ROLE.SUPER_ADMIN, USER_ROLE.CUSTOMER), TrackDriverControllers.getNearbyDrivers);
/**
