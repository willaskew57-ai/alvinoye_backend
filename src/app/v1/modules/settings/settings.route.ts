...
router.post(
  ...
  validateRequest(SettingValidation.CreatePrivacyPolicyValidationSchema),
  SettingsControllers.CreatePrivacyPolicy
);
...
router.patch(
  '/privacy-policy/:id',
  validateRequest(SettingValidation.UpdatePrivacyPolicyValidationSchema),
