...
const markAsRead = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await NotificationServices.markAsReadInDB(id as string, userId);
...
const deleteNotification = catchAsync(async (req: Request, res: Response) => {
  ...
  await NotificationServices.deleteNotificationFromDB(id as string, userId);
...
const deleteAllNotifications = catchAsync(
  async (req: Request, res: Response) => {
    const userId = req.user?.user_id;
    const result = await NotificationServices.deleteAllNotificationsFromDB(
      userId
    );
