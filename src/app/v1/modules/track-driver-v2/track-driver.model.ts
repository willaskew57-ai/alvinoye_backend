...
import type { TDriverLocation } from './track-driver.interface';

const DriverLocationSchema = new Schema<TDriverLocation>(
  {
    driver_id: {
...
export const DriverLocation = model<TDriverLocation>(
  'DriverLocation',
